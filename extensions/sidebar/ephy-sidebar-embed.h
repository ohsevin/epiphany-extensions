...
#define EPHY_SIDEBAR__EMBEDCLASS(k)	(G_TYPE_CHECK_CLASS_CAST((k), EPHY_TYPE_SIDEBAR_EMBED, EphySidebarEmbedClass))
...
#define EPHY_SIDEBAR__EMBEDGET_CLASS(o)	(G_TYPE_INSTANCE_GET_CLASS ((o), EPHY_TYPE_SIDEBAR_EMBED, EphySidebarEmbedClass))
