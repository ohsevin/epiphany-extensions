...
{
	LOG ("Registering EphyExtensionsManagerUiExtension");
	...
	extensions_manager_ui_register_type (module);
	return ephy_extensions_manager_ui_extension_register_type (module);
}
